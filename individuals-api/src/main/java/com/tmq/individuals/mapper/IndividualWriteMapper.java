...
public class IndividualWriteMapper {
    ...
    private com.tmq.person.service.dto.AddressWriteDto toAddressWriteDto(com.tmq.individuals.dto.AddressWriteDto src) {
        if (src == null) return null;
        com.tmq.person.service.dto.AddressWriteDto dest = new com.tmq.person.service.dto.AddressWriteDto();
